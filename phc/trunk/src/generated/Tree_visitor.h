...
public:
	...
	virtual void pre_class_mod_list(AST_class_mod_list* in);
	virtual void children_class_mod_list(AST_class_mod_list* in);
	virtual void post_class_mod_list(AST_class_mod_list* in);
	virtual void pre_class_name_list(Token_class_name_list* in);
	virtual void children_class_name_list(Token_class_name_list* in);
	virtual void post_class_name_list(Token_class_name_list* in);
	virtual void pre_signature_list(AST_signature_list* in);
	virtual void children_signature_list(AST_signature_list* in);
	virtual void post_signature_list(AST_signature_list* in);
	...
	virtual void pre_method_mod_list(AST_method_mod_list* in);
	virtual void children_method_mod_list(AST_method_mod_list* in);
	virtual void post_method_mod_list(AST_method_mod_list* in);
	virtual void pre_method_name_list(Token_method_name_list* in);
	virtual void children_method_name_list(Token_method_name_list* in);
	virtual void post_method_name_list(Token_method_name_list* in);
	...
	virtual void pre_type_list(AST_type_list* in);
	virtual void children_type_list(AST_type_list* in);
	virtual void post_type_list(AST_type_list* in);
	virtual void pre_variable_name_list(Token_variable_name_list* in);
	virtual void children_variable_name_list(Token_variable_name_list* in);
	virtual void post_variable_name_list(Token_variable_name_list* in);
	...
	virtual void pre_attr_mod_list(AST_attr_mod_list* in);
	virtual void children_attr_mod_list(AST_attr_mod_list* in);
	virtual void post_attr_mod_list(AST_attr_mod_list* in);
	virtual void pre_variable_list(AST_variable_list* in);
	virtual void children_variable_list(AST_variable_list* in);
	virtual void post_variable_list(AST_variable_list* in);
	...
	virtual void pre_directive_name_list(Token_directive_name_list* in);
	virtual void children_directive_name_list(Token_directive_name_list* in);
	virtual void post_directive_name_list(Token_directive_name_list* in);
	...
	virtual void pre_list_elements_list(AST_list_elements_list* in);
	virtual void children_list_elements_list(AST_list_elements_list* in);
	virtual void post_list_elements_list(AST_list_elements_list* in);
	...
	virtual void pre_cast_list(Token_cast_list* in);
	virtual void children_cast_list(Token_cast_list* in);
	virtual void post_cast_list(Token_cast_list* in);
	virtual void pre_op_list(Token_op_list* in);
	virtual void children_op_list(Token_op_list* in);
	virtual void post_op_list(Token_op_list* in);
	virtual void pre_constant_name_list(Token_constant_name_list* in);
	virtual void children_constant_name_list(Token_constant_name_list* in);
	virtual void post_constant_name_list(Token_constant_name_list* in);
	virtual void pre_class_name_list(AST_class_name_list* in);
	virtual void children_class_name_list(AST_class_name_list* in);
	virtual void post_class_name_list(AST_class_name_list* in);
	virtual void pre_target_list(AST_target_list* in);
	virtual void children_target_list(AST_target_list* in);
	virtual void post_target_list(AST_target_list* in);
	virtual void pre_variable_name_list(AST_variable_name_list* in);
	virtual void children_variable_name_list(AST_variable_name_list* in);
	virtual void post_variable_name_list(AST_variable_name_list* in);
	...
	virtual void pre_method_name_list(AST_method_name_list* in);
	virtual void children_method_name_list(AST_method_name_list* in);
	virtual void post_method_name_list(AST_method_name_list* in);
